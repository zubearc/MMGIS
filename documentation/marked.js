...
(function (global, factory) {
  ...
  const defaults = createCommonjsModule(function (module) {
  ...
  const noopTest$1 = helpers.noopTest
  const edit$1 = helpers.edit
  const merge$1 = helpers.merge
  /**
   * Block-Level Grammar
   */
  ...
  const defaults$1 = defaults.defaults
  const block$1 = rules.block
  const rtrim$1 = helpers.rtrim
  const splitCells$1 = helpers.splitCells
  const escape$1 = helpers.escape
  /**
   * Block Lexer
   */

  const Lexer_1 = /* #__PURE__ */(function () {
  ...
  const defaults$2 = defaults.defaults
  const cleanUrl$1 = helpers.cleanUrl
  const escape$2 = helpers.escape
  /**
   * Renderer
   */

  const Renderer_1 = /* #__PURE__ */(function () {
   ...
   */
  const Slugger_1 = /* #__PURE__ */(function () {
    function Slugger () {
      this.seen = {}
    }
    /**
  ...
  const defaults$3 = defaults.defaults
  const inline$1 = rules.inline
  const findClosingBracket$1 = helpers.findClosingBracket
  const escape$3 = helpers.escape
  /**
   * Inline Lexer & Compiler
   */

  const InlineLexer_1 = /* #__PURE__ */(function () {
    ...
    const _proto = InlineLexer.prototype
   ...
   */
  const TextRenderer_1 = /* #__PURE__ */(function () {
  ...
  const defaults$4 = defaults.defaults
  const merge$2 = helpers.merge
  const unescape$1 = helpers.unescape
  /**
   * Parsing & Compiling
   */

  const Parser_1 = /* #__PURE__ */(function () {
  ...
  const merge$3 = helpers.merge
  const checkSanitizeDeprecation$1 = helpers.checkSanitizeDeprecation
  const escape$4 = helpers.escape
  const getDefaults = defaults.getDefaults
  const changeDefaults = defaults.changeDefaults
  const defaults$5 = defaults.defaults
  /**
   * Marked
   */
